...
grabar.addEventListener('click',()=>{
  let datos={
    ...
    "faltaAsistencia":faltaAsistencia.checked,
    "desconsideracion":desconsideracion.checked,
    "interrumpeClase":interrumpeClase.checked,
    "alteraActividades":alteraActividades.checked,
    "conductasImpropias":conductasImpropias.checked,
    "indisciplina":indisciplina.checked,
    "deterioroClase":deterioroClase.checked,
    "deterioroPropiedades":deterioroPropiedades.checked,
    "usaAscensor":usaAscensor.checked,
    "actoInjustificado":actoInjustificado.checked,
    "indisciplinaGrave":indisciplinaGrave.checked,
    "perjuicioSalud":perjuicioSalud.checked,
    "agresionGrave":agresionGrave.checked,
    "suplantacion":suplantacion.checked,
    "danyoGrave":danyoGrave.checked,
    "racista":racista.checked,
    "reiteracion":reiteracion.checked,
    "incumplimiento":incumplimiento.checked,
    "abandonaCentro":abandonaCentro.checked,
    "usaMovil":usaMovil.checked,
    "movilExamen":movilExamen.checked
  }
